    ...
    <div className="cd-page">
      ...
      <section className="dest-detail__location cd-block">
        ...
        <div className="dest-detail__location-content">
          <a
            className="dest-detail__location-info"
            href={`https://www.google.com/maps/search/${encodeURIComponent([venue.nameEn, venue.city, venue.country].filter(Boolean).join(', '))}`}
            target="_blank"
          ...
          >
            ...
            <div>
              ...
              <span className="dest-detail__location-link">在 Google Maps 中搜索 →</span>
            </div>
          </a>
        </div>
      </section>
